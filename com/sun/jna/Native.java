...
implements Version {
    ...
    private static void loadNativeDispatchLibrary() {
        ...
        if (bootPath != null) {
            ...
            while (dirs.hasMoreTokens()) {
                String ext;
                String orig;
                String dir2 = dirs.nextToken();
                File file = new File(new File(dir2), System.mapLibraryName(libName).replace(".dylib", ".jnilib"));
    ...
    public static File extractFromResourcePath(String name, ClassLoader loader) throws IOException {
        ...
        if (url.getProtocol().toLowerCase().equals("file")) {
            ...
            try {
                int count;
                File dir2 = Native.getTempDir();
                lib = File.createTempFile(JNA_TMPLIB_PREFIX, Platform.isWindows() ? ".dll" : null, dir2);
    ...
    public static void main(String[] args) {
        ...
        String DEFAULT_VERSION = "5.8.0";
        String DEFAULT_BUILD = "5.8.0 (package information missing)";
        ...
        String string2 = version = pkg != null ? pkg.getSpecificationVersion() : "5.8.0";
        if (version == null) {
            version = "5.8.0";
        }
        title = title + " API Version " + version;
        System.out.println(title);
        String string3 = version = pkg != null ? pkg.getImplementationVersion() : "5.8.0 (package information missing)";
        if (version == null) {
