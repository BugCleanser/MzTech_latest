...
public abstract class FileMonitor {
    ...
    public void addWatch(File dir2) throws IOException {
        this.addWatch(dir2, 511);
    }

    public void addWatch(File dir2, int mask) throws IOException {
        this.addWatch(dir2, mask, dir2.isDirectory());
    }

    public void addWatch(File dir2, int mask, boolean recursive) throws IOException {
        this.watched.put(dir2, mask);
        this.watch(dir2, mask, recursive);
    }
