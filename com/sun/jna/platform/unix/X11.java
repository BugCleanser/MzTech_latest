...
extends Library {
    public static final X11 INSTANCE = Native.load("X11", X11.class);
    ...
    extends Library {
        public static final XTest INSTANCE = Native.load("Xtst", XTest.class);
    ...
    extends Library {
        public static final Xevie INSTANCE = Native.load("Xevie", Xevie.class);
    ...
    extends Library {
        public static final Xrender INSTANCE = Native.load("Xrender", Xrender.class);
    ...
    extends Library {
        public static final Xext INSTANCE = Native.load("Xext", Xext.class);
    ...
    extends PointerType {
        public VisualID getVisualID() {
            if (this.getPointer() != null) {
                return new VisualID(this.getPointer().getNativeLong(Native.POINTER_SIZE).longValue());
            }
