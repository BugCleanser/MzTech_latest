...
public abstract class PsapiUtil {
    ...
    public static String GetProcessImageFileName(WinNT.HANDLE process) {
        char[] filePath;
        int length;
        int size = 2048;
        while ((length = Psapi.INSTANCE.GetProcessImageFileName(process, filePath = new char[size], filePath.length)) == 0) {
