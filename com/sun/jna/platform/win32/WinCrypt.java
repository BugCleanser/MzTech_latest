...
public interface WinCrypt {
    ...
    extends Structure {
        ...
        public CERT_CONTEXT[] getRgpMsgCert() {
            ...
            for (int i = 0; i < elements.length; ++i) {
                elements[i] = Structure.newInstance(CERT_CONTEXT.class, this.rgpMsgCert.getPointer(i * Native.POINTER_SIZE));
                elements[i].read();
            }
            return elements;
        }
        ...
        public CRL_CONTEXT[] getRgpMsgCrl() {
            ...
            for (int i = 0; i < elements.length; ++i) {
                elements[i] = Structure.newInstance(CRL_CONTEXT.class, this.rgpMsgCrl.getPointer(i * Native.POINTER_SIZE));
                elements[i].read();
            }
            return elements;
        }
    ...
    extends Structure {
        ...
        public CRYPT_KEY_PROV_PARAM[] getRgProvParam() {
            ...
            for (int i = 0; i < elements.length; ++i) {
                elements[i] = Structure.newInstance(CRYPT_KEY_PROV_PARAM.class, this.rgProvParam.getPointer(i * Native.POINTER_SIZE));
                elements[i].read();
            }
            return elements;
        }
    ...
    extends Structure {
        ...
        public CRL_ENTRY[] getRgCRLEntry() {
            ...
            CRL_ENTRY[] result = (CRL_ENTRY[])Structure.newInstance(CRL_ENTRY.class, this.rgCRLEntry).toArray(this.cCRLEntry);
            result[0].read();
            return result;
        }
        ...
        public CERT_EXTENSION[] getRgExtension() {
            ...
            CERT_EXTENSION[] result = (CERT_EXTENSION[])Structure.newInstance(CERT_EXTENSION.class, this.rgExtension).toArray(this.cExtension);
            result[0].read();
            return result;
        }
    ...
    extends Structure {
        ...
        public CERT_EXTENSION[] getRgExtension() {
            ...
            CERT_EXTENSION[] ces = (CERT_EXTENSION[])Structure.newInstance(CERT_EXTENSION.class, this.rgExtension).toArray(this.cExtension);
            ces[0].read();
            return ces;
        }
    ...
    extends Structure {
        ...
        public CERT_SIMPLE_CHAIN[] getRgpChain() {
            ...
            for (int i = 0; i < elements.length; ++i) {
                elements[i] = Structure.newInstance(CERT_SIMPLE_CHAIN.class, this.rgpChain.getPointer(i * Native.POINTER_SIZE));
                elements[i].read();
            }
            return elements;
        }
        ...
        public CERT_CHAIN_CONTEXT[] getRgpLowerQualityChainContext() {
            ...
            for (int i = 0; i < elements.length; ++i) {
                elements[i] = Structure.newInstance(CERT_CHAIN_CONTEXT.class, this.rgpLowerQualityChainContext.getPointer(i * Native.POINTER_SIZE));
                elements[i].read();
            }
            return elements;
        }
    ...
    extends Structure {
        ...
        public CERT_CHAIN_ELEMENT[] getRgpElement() {
            ...
            for (int i = 0; i < elements.length; ++i) {
                elements[i] = Structure.newInstance(CERT_CHAIN_ELEMENT.class, this.rgpElement.getPointer(i * Native.POINTER_SIZE));
                elements[i].read();
            }
            return elements;
        }
    ...
    extends Structure {
        ...
        public CTL_ENTRY[] getRgCTLEntry() {
            ...
            CTL_ENTRY[] result = (CTL_ENTRY[])Structure.newInstance(CTL_ENTRY.class, this.rgCTLEntry).toArray(this.cCTLEntry);
            result[0].read();
            return result;
        }
    ...
    extends Structure {
        ...
        public CRYPT_ATTRIBUTE[] getRgAttribute() {
            ...
            CRYPT_ATTRIBUTE[] result = (CRYPT_ATTRIBUTE[])Structure.newInstance(CRYPT_ATTRIBUTE.class, this.rgAttribute).toArray(this.cAttribute);
            result[0].read();
            return result;
        }
