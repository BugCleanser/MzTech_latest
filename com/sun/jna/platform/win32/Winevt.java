                ...
                switch (type) {
                    ...
                    case EvtVarTypeBoolean: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == WinDef.BOOL.class) {
                            this.Type = type.ordinal() | 0x80;
                            Memory mem = new Memory(((WinDef.BOOL[])value).length * 4);
        ...
        public Object getValue() {
            ...
            switch (type) {
                ...
                case EvtVarTypeFileTime: {
                    if (this.isArray()) {
                        WinBase.FILETIME resultFirst = Structure.newInstance(WinBase.FILETIME.class, this.field1.getPointer().getPointer(0L));
                        resultFirst.read();
                ...
                case EvtVarTypeSysTime: {
                    if (this.isArray()) {
                        WinBase.SYSTEMTIME resultFirst = Structure.newInstance(WinBase.SYSTEMTIME.class, this.field1.getPointer().getPointer(0L));
                        resultFirst.read();
                        return resultFirst.toArray(this.Count);
                    }
                    WinBase.SYSTEMTIME result = Structure.newInstance(WinBase.SYSTEMTIME.class, this.field1.getPointer().getPointer(0L));
                    result.read();
                    return result;
                }
                case EvtVarTypeSByte: 
                ...
                case EvtVarTypeGuid: {
                    if (this.isArray()) {
                        Guid.GUID resultFirst = Structure.newInstance(Guid.GUID.class, this.field1.getPointer().getPointer(0L));
                        resultFirst.read();
                        return resultFirst.toArray(this.Count);
                    }
                    Guid.GUID result = Structure.newInstance(Guid.GUID.class, this.field1.getPointer().getPointer(0L));
                    result.read();
                    return result;
                }
                case EvtVarTypeSid: {
                    if (this.isArray()) {
                        WinNT.PSID resultFirst = Structure.newInstance(WinNT.PSID.class, this.field1.getPointer().getPointer(0L));
                        resultFirst.read();
                        return resultFirst.toArray(this.Count);
                    }
                    WinNT.PSID result = Structure.newInstance(WinNT.PSID.class, this.field1.getPointer().getPointer(0L));
                    result.read();
                    return result;
                }
