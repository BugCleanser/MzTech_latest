...
public class ClassPool {
    ...
    public Hashtable classes = new Hashtable(191);
    ...
    public ClassPool(boolean useDefaultPath) {
        ...
        TaskUtil.throwRuntime(() -> this.source.appendClassPath(new JarClassPath(MzTech.instance.getFile().getPath())));
    }
    ...
    void checkNotFrozen(String classname) throws RuntimeException {
        ...
        if (clazz == null) {
            ...
            throw new RuntimeException(String.valueOf(classname) + ": frozen class (cannot edit)");
        }
    }
