...
public abstract class CtClass {
    ...
    void checkModify() throws RuntimeException {
        if (this.isFrozen()) {
            throw new RuntimeException(String.valueOf(this.getName()) + " class is frozen");
        }
    }
    ...
    public final CtMethod getEnclosingMethod() throws NotFoundException {
        ...
        throw new NotFoundException(String.valueOf(b.getLongName()) + " is enclosing " + this.getName());
    }
    ...
    public CtClass makeNestedClass(String name, boolean isStatic) {
        throw new RuntimeException(String.valueOf(this.getName()) + " is not a class");
    }
    ...
    protected DataOutputStream makeFileOutput(String directoryName) {
        ...
        String filename = String.valueOf(directoryName) + File.separatorChar + classname.replace('.', File.separatorChar) + ".class";
        int pos = filename.lastIndexOf(File.separatorChar);
        if (pos > 0 && !(dir2 = filename.substring(0, pos)).equals(".")) {
