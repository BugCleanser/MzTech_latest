...
extends CtClass {
    ...
    void checkModify() throws RuntimeException {
        if (this.isFrozen()) {
            String msg = String.valueOf(this.getName()) + " class is frozen";
            if (this.wasPruned) {
                msg = String.valueOf(msg) + " and pruned";
            }
    ...
    public CtClass[] getNestedClasses() throws NotFoundException {
        ...
        String thisName = String.valueOf(cf.getName()) + "$";
    ...
    public CtClass makeNestedClass(String name, boolean isStatic) {
        ...
        this.checkModify();
        CtClass c = this.classPool.makeNestedClass(String.valueOf(this.getName()) + "$" + name);
        ClassFile cf = this.getClassFile2();
    ...
    private CtField checkGetField(CtField f, String name, String desc) throws NotFoundException {
        if (f == null) {
            ...
            if (desc != null) {
                msg = String.valueOf(msg) + " type " + desc;
            }
            throw new NotFoundException(String.valueOf(msg) + " in " + this.getName());
        }
        return f;
    }
    ...
    public CtMethod getMethod(String name, String desc) throws NotFoundException {
        ...
        throw new NotFoundException(String.valueOf(name) + "(..) is not found in " + this.getName());
    }
        ...
        block8: {
            ...
            if (init != null) {
                ...
                if (Modifier.isStatic(mod) && Modifier.isFinal(mod)) {
                    try {
                        cp = this.getClassFile2().getConstPool();
                        index = init.getConstantValue(cp, f.getType());
                        if (index != 0) {
...
lbl29:
    ...
    private void checkPruned(String method) {
        if (this.wasPruned) {
            throw new RuntimeException(String.valueOf(method) + "(): " + this.getName() + " was pruned.");
        }
    }
    ...
    public String makeUniqueName(String prefix) {
        ...
        } while (!CtClassType.notFindInArray(name = String.valueOf(prefix) + i++, methods));
        return name;
    }
