...
extends AttributeInfo {
    ...
    extends Walker {
        ...
        public void sameFrame(int pos, int offsetDelta) {
            ...
            this.writer.println(String.valueOf(this.offset) + " same frame: " + offsetDelta);
        }

        @Override
        public void sameLocals(int pos, int offsetDelta, int stackTag, int stackData) {
            this.offset += offsetDelta + 1;
            this.writer.println(String.valueOf(this.offset) + " same locals: " + offsetDelta);
        ...
        public void chopFrame(int pos, int offsetDelta, int k) {
            this.offset += offsetDelta + 1;
            this.writer.println(String.valueOf(this.offset) + " chop frame: " + offsetDelta + ",    " + k + " last locals");
        }

        @Override
        public void appendFrame(int pos, int offsetDelta, int[] tags, int[] data) {
            this.offset += offsetDelta + 1;
            this.writer.println(String.valueOf(this.offset) + " append frame: " + offsetDelta);
            int i = 0;
            while (i < tags.length) {
        ...
        public void fullFrame(int pos, int offsetDelta, int[] localTags, int[] localData, int[] stackTags, int[] stackData) {
            this.offset += offsetDelta + 1;
            this.writer.println(String.valueOf(this.offset) + " full frame: " + offsetDelta);
            this.writer.println("[locals]");
            int i = 0;
            while (i < localTags.length) {
