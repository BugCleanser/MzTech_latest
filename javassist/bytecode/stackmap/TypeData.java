...
public abstract class TypeData {
    ...
    public String toString() {
        return String.valueOf(super.toString()) + "(" + this.toString2(new HashSet<TypeData>()) + ")";
    }
    ...
    public static CtClass commonSuperClassEx(CtClass one, CtClass two) throws NotFoundException {
        ...
        if (one.isArray() && two.isArray()) {
            ...
            return one.getClassPool().get(element == null ? "java.lang.Object" : String.valueOf(element.getName()) + "[]");
        }
    ...
    extends TypeData {
        ...
        public TypeData getArrayType(int dim) throws NotFoundException {
            ...
            if (dim > 0) {
                ...
                return new ClassName(String.valueOf(new String(dimType)) + elementType);
            }
            int i = 0;
            while (i < -dim) {
    ...
    extends ClassName {
        ...
        @Override
        String toString2(Set<TypeData> set) {
            return String.valueOf(this.getName()) + "," + this.offset;
        }
    }
