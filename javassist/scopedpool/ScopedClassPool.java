    ...
    protected CtClass getCached(String classname) {
        ...
        if (clazz == null) {
            ...
            if (dcl != null) {
                ...
                classResourceName = lastIndex < 0 ? String.valueOf(classname.replaceAll("[\\.]", "/")) + ".class" : String.valueOf(classname.substring(0, lastIndex).replaceAll("[\\.]", "/")) + classname.substring(lastIndex) + ".class";
