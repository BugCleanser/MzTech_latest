    ...
    public static String decompile(String source, int flags, UintMap properties) {
        ...
        block102: while (i < length) {
            switch (source.charAt(i)) {
                ...
                case 'Y': {
                    result.append(')');
                    if (86 != Decompiler.getNext(source, length, i)) break;
                    result.append(' ');
                    break;
                }
                case 'T': {
                ...
                case '\u0001': {
                    ...
                    if (nextToken == 't' || nextToken == 'u') {
                        ...
                        less = indentGap;
                    } else if (nextToken == '\'' && source.charAt(afterName = Decompiler.getSourceStringEnd(source, i + 2)) == 'h') {
                        less = indentGap;
                    }
                    while (less < indent) {
                        result.append(' ');
                ...
                case '\u0004': {
                    ...
                    if (83 == Decompiler.getNext(source, length, i)) break;
                    result.append(' ');
                    break;
                }
                case '{': {
