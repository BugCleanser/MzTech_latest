        ...
        block232: {
            ...
            block131: while (true) {
                block233: {
                                ...
                                block133: while (true) {
                                    ...
                                    switch (op) {
                                        ...
                                        case 73: {
                                            ...
                                            if (obj == Scriptable.NOT_FOUND) continue block133;
                                            throwable = obj;
                                            break block231;
                                        }
                                        case -63: {
                                        ...
                                        case -24: {
                                            ...
                                            if (stackTop == frame.emptyStackTop) continue block133;
                                            Kit.codeBug();
                                            continue block133;
                                        }
                                        case -25: {
                                            ...
                                            if (!instructionCounting) continue block133;
                                        ...
                                        case 76: {
                                            Object value = stack[stackTop];
                                            if (value == DBL_MRK) continue block133;
                                        ...
                                        case -64: {
                                            if (frame.debuggerFrame == null) continue block133;
                    ...
                    do {
                        boolean onlyFinally;
                        if (exState != 0 && (indexReg = Interpreter.getExceptionHandler(frame, onlyFinally = exState != 2)) >= 0) continue block131;
                        Interpreter.exitFrame(cx, frame, throwable);
                        frame = frame.parentFrame;
                        if (frame == null) break block233;
                    } while (cjump == null || cjump.branchFrame != frame);
                    indexReg = -1;
                    continue;
                }
                if (cjump == null) break block232;
