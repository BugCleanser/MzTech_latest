...
extends IdScriptableObject {
    ...
    private static Object str(Object key, Scriptable holder, StringifyState state) {
        ...
        if (value instanceof Scriptable && NativeJSON.hasProperty((Scriptable)value, "toJSON") && (toJSON = NativeJSON.getProperty((Scriptable)value, "toJSON")) instanceof Callable) {
