...
ConstProperties {
    ...
    protected static ScriptableObject buildDataDescriptor(Scriptable scope, Object value, int attributes) {
        ...
        desc.defineProperty("writable", (Object)((attributes & 1) == 0 ? 1 : 0), 0);
        desc.defineProperty("enumerable", (Object)((attributes & 2) == 0 ? 1 : 0), 0);
        desc.defineProperty("configurable", (Object)((attributes & 4) == 0 ? 1 : 0), 0);
        return desc;
    }
    ...
    public int getAttributes(String name) {
        return this.findAttributeSlot(name, 0, SlotAccess.QUERY).getAttributes();
    }

    public int getAttributes(int index) {
        return this.findAttributeSlot(null, index, SlotAccess.QUERY).getAttributes();
    }
    ...
    public void setAttributes(String name, int attributes) {
        this.checkNotSealed(name, 0);
        this.findAttributeSlot(name, 0, SlotAccess.MODIFY).setAttributes(attributes);
    }

    public void setAttributes(int index, int attributes) {
        this.checkNotSealed(null, index);
        this.findAttributeSlot(null, index, SlotAccess.MODIFY).setAttributes(attributes);
    }
        ...
        ScriptableObject getPropertyDescriptor(Context cx, Scriptable scope) {
            ...
            if (this.getter != null) {
                if (this.getter instanceof MemberBox) {
                    desc.defineProperty("get", (Object)new FunctionObject(fName, ((MemberBox)this.getter).member(), scope), 0);
                } else if (this.getter instanceof Member) {
                    desc.defineProperty("get", (Object)new FunctionObject(fName, (Member)this.getter, scope), 0);
                } else {
            ...
            if (this.setter != null) {
                if (this.setter instanceof MemberBox) {
                    desc.defineProperty("set", (Object)new FunctionObject(fName, ((MemberBox)this.setter).member(), scope), 0);
                } else if (this.setter instanceof Member) {
                    desc.defineProperty("set", (Object)new FunctionObject(fName, (Member)this.setter, scope), 0);
                } else {
