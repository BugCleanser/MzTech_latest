...
implements Evaluator {
    ...
    private void generateCallMethod(ClassFileWriter cfw, boolean isStrictMode) {
        ...
        for (int i = 0; i != end; ++i) {
            ...
            if (n.getType() == 110 && (ofn = OptFunctionNode.get(n)).isTargetOfDirectCall() && (pcount = ofn.fnode.getParamCount()) != 0) {
    ...
    String getBodyMethodSignature(ScriptNode n) {
        ...
        if (n.getType() == 110 && (ofn = OptFunctionNode.get(n)).isTargetOfDirectCall()) {
