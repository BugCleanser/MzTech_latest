...
class Frame {
    ...
    final void a(ClassWriter classWriter, int n, Object[] objectArray, int n2, Object[] objectArray2) {
        int n3 = Frame.a(classWriter, n, objectArray, this.c);
        ...
        this.d = new int[n2 + n4];
        Frame.a(classWriter, n2, objectArray2, this.d);
        this.g = 0;
        this.h = 0;
    }

    private static int a(ClassWriter classWriter, int n, Object[] objectArray, int[] nArray) {
        int n2 = 0;
        for (int i = 0; i < n; ++i) {
            if (objectArray[i] instanceof Integer) {
                nArray[n2++] = 0x1000000 | (Integer)objectArray[i];
                if (objectArray[i] != Opcodes.LONG && objectArray[i] != Opcodes.DOUBLE) continue;
                nArray[n2++] = 0x1000000;
                continue;
            }
            nArray[n2++] = objectArray[i] instanceof String ? Frame.b(classWriter, Type.getObjectType((String)objectArray[i]).getDescriptor()) : 0x1800000 | classWriter.a("", ((Label)objectArray[i]).c);
        }
        return n2;
    }
    ...
    final void a(ClassWriter classWriter, int n, Type[] typeArray, int n2) {
        this.c = new int[n2];
        this.d = new int[0];
        int n3 = 0;
        if ((n & 8) == 0) {
    ...
    final boolean a(ClassWriter classWriter, Frame frame, int n) {
        int n2;
        int n3;
        int n4;
        int n5;
        ...
        if ((n4 & 0xFF00000) == 0x1700000 || (n4 & 0xF0000000) != 0) {
            ...
            if ((n & 0xFFF00000) == (n4 & 0xFFF00000)) {
                if ((n4 & 0xFF00000) == 0x1700000) {
                    n3 = n & 0xF0000000 | 0x1700000 | classWriter.a(n & 0xFFFFF, n4 & 0xFFFFF);
                } else {
                    int n5 = -268435456 + (n4 & 0xF0000000);
                    n3 = n5 | 0x1700000 | classWriter.c("java/lang/Object");
                }
                ...
                n3 = Math.min(n6, n7) | 0x1700000 | classWriter.c("java/lang/Object");
            } else {
                n3 = 0x1000000;
            }
        } else {
