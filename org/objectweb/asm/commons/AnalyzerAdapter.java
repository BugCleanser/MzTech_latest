...
extends MethodVisitor {
    ...
    public AnalyzerAdapter(String string, int n, String string2, String string3, MethodVisitor methodVisitor) {
        this(327680, string, n, string2, string3, methodVisitor);
    ...
    protected AnalyzerAdapter(int n, String string, int n2, String string2, String string3, MethodVisitor methodVisitor) {
        ...
        block7: for (int i = 0; i < typeArray.length; ++i) {
            ...
            switch (type.getSort()) {
                ...
                case 9: {
                    this.locals.add(typeArray[i].getDescriptor());
                    continue block7;
                }
                default: {
                    this.locals.add(typeArray[i].getInternalName());
                }
            }
        }
    ...
    public void visitFrame(int n, int n2, Object[] objectArray, int n3, Object[] objectArray2) {
        ...
        AnalyzerAdapter.visitFrameTypes(n2, objectArray, this.locals);
        AnalyzerAdapter.visitFrameTypes(n3, objectArray2, this.stack);
        this.maxStack = Math.max(this.maxStack, this.stack.size());
    }

    private static void visitFrameTypes(int n, Object[] objectArray, List list) {
        for (int i = 0; i < n; ++i) {
