...
extends MethodVisitor {
    ...
    private void doVisitMethodInsn(int n, String string, String string2, String string3, boolean bl) {
        switch (n) {
            case 183: {
                this.invokespecial(string, string2, string3, bl);
                break;
            }
            case 182: {
                this.invokevirtual(string, string2, string3, bl);
                break;
            }
            case 184: {
                this.invokestatic(string, string2, string3, bl);
                break;
            }
            case 185: {
    ...
    public void visitTableSwitchInsn(int n, int n2, Label label, Label ... labelArray) {
        this.tableswitch(n, n2, label, labelArray);
    }
    ...
    public void invokevirtual(String string, String string2, String string3, boolean bl) {
        if (this.api < 327680) {
            if (bl) {
        ...
        this.mv.visitMethodInsn(182, string, string2, string3, bl);
    }
    ...
    public void invokespecial(String string, String string2, String string3, boolean bl) {
        if (this.api < 327680) {
            if (bl) {
        ...
        this.mv.visitMethodInsn(183, string, string2, string3, bl);
    }
    ...
    public void invokestatic(String string, String string2, String string3, boolean bl) {
        if (this.api < 327680) {
            if (bl) {
        ...
        this.mv.visitMethodInsn(184, string, string2, string3, bl);
    }
