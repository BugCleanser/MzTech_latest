...
extends ASMContentHandler$Rule {
    ...
    public void begin(String string, Attributes attributes) {
        ...
        if (object instanceof ClassVisitor) {
            this.this$0.push(((ClassVisitor)object).visitTypeAnnotation(n, typePath, string2, bl));
        } else if (object instanceof FieldVisitor) {
            this.this$0.push(((FieldVisitor)object).visitTypeAnnotation(n, typePath, string2, bl));
        } else if (object instanceof MethodVisitor) {
            this.this$0.push(((MethodVisitor)object).visitTypeAnnotation(n, typePath, string2, bl));
        }
    }
