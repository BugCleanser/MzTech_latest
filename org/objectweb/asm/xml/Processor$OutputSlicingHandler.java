...
extends DefaultHandler {
    ...
    Processor$OutputSlicingHandler(Processor$ContentHandlerFactory processor$ContentHandlerFactory, Processor$EntryElement processor$EntryElement, boolean bl) {
